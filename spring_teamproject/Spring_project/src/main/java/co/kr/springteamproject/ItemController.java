...
public class ItemController {
	...
	public String replyDeletePro(Model model,String num,String reply_rno) {
		int num1=Integer.parseInt(num);
		int num2=Integer.parseInt(reply_rno);
		//ReplyDto replyDto=sqlSession.selectOne("itemReply.getReply",num1);
		HashMap<String, Integer> map=new HashMap<String, Integer>();
		map.put("item_no",num1);
		map.put("reply_rno",num2);
		sqlSession.delete("itemReply.replyDelete",map);
